<?php
    ...
    abstract class Manager{
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        // Cette fonction sert à afficher la liste des topics, des posts avec toutes les données
        ...
        // Créer une fonction générique pour afficher la liste des topics d'une catégorie
        // Cette fonction peut être réutiliser pour obtenir la liste des posts d'un topic
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        // FONCTION POUR TROUVER UNE ENTITE PAR SON ID
        ...
        private function generate($rows, $class){
            foreach($rows as $row){
                yield new $class($row);// Ici se créer l'instance de la classe
            }
        }
